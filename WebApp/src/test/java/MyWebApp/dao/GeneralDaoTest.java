...
import MyWebApp.dao.Impl.stationsDao;
...
public class GeneralDaoTest {
    ...
    public void searchTest() {
        ...
        stationsDao dstations = new stationsDao();
        Map<String, String> to_s = new HashMap<>();
        to_s.put("name", "Midgard");
        List<MyWebApp.entity.stations> res3 = dstations.<String>search(to_s);
